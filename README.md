...
`@juicerq/jubs/dashboard` mounts a [Bull Board](https://github.com/felixmosh/bull-board) over the queues your definitions use. It is the read side of everything above: what is waiting, what failed, what a job's envelope holds, and what is sitting in a dead queue.
...
| `schedule` | one occurrence of a [schedule](#scheduling) |
| `flow` | a node of a [flow](#flows) |
| `relay` | a row the [outbox relay](#outbox-and-relay) delivered |
